...
const PopupModal = () => {
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 w-fu h-ful z-[999]">
      <div className="relatie w-full h-full flex justify-center items-center">
      ...
      <div className="relative w-full h-full max-w-2xl md:h-auto">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <CommonButton btnLabel="I accept"  />
            {/* <button
              data-modal-hide="defaultModal"
              type="button"
...
export const Texting = () => {
  return (
    <div className="bg-white rounded-lg shadow dark:bg-gray-700 w-96 md:w-[700px]">
      <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
        <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
          Terms of Service
        </h3>
      ...
      <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
      <CommonButton btnLabel="I accept" customClass="rounded"  />
      <CommonButton btnLabel="Decline"  />
      </div>
    </div>
  );
};
